...
export function NewsHeroSection({ config }: HeroSectionProps) {
  return (
    <FullSection className="bg-[url('/assets/images/HeroNewsPage-bg.png')] bg-cover bg-center text-white relative min-h-[400px] flex items-center">
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-r from-primary-900/90 to-primary-700/80" />

      <CenteredSection className="relative py-20 w-full">
