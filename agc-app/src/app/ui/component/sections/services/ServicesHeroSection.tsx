...
import { ServicesHeroConfig } from "@/types/services-type";

interface ServicesHeroSectionProps {
  config: ServicesHeroConfig;
}

export function ServicesHeroSection({ config }: ServicesHeroSectionProps) {
  return (
    <FullSection
      className="bg-[url('/assets/images/HeroservicePage-bg.png')] bg-cover bg-center text-white relative min-h-[400px] flex items-center"
    >
      {/* Overlay */}
